...
class ModernLessonManager {
    ...
    setupIPC() {
        ...
        electron_1.ipcMain.handle('teacher:getById', (_, id) => this.teacherManager.getById(id));
        ...
        electron_1.ipcMain.handle('class:getById', (_, id) => this.classManager.getById(id));
        electron_1.ipcMain.handle('class:getByGrade', (_, grade) => this.classManager.getByGrade(grade));
        ...
        electron_1.ipcMain.handle('lesson:getById', (_, id) => this.lessonManager.getById(id));
