...
export declare class AssignmentAlertManager {
     ...
     */
    createAlert(classId: number, type: AlertType, message: string, severity?: AlertSeverity): Promise<number>;
    /**
     * Updates the severity of an existing alert
     */
    updateAlertSeverity(alertId: number, severity: AlertSeverity): Promise<boolean>;
    /**
